...
class HistorialFrame(tk.Frame):
    def __init__(self, parent, controller=None):
        ...
        # Contenido
        self.contenido_frame = tk.Frame(self, bg=COLORS["bg_main"])
        self.contenido_frame.pack(padx=20, pady=10, fill='both', expand=True)
    ...
    def mostrar_historial(self):
        ...
        # Ficha del empleado
        info_frame = tk.LabelFrame(self.contenido_frame, text="Ficha del Empleado", font=FONT_NORMAL,
                                   bg=COLORS["bg_card"], fg=COLORS["text_dark"], padx=20, pady=15, relief="ridge")
        info_frame.pack(fill="x", padx=10, pady=(10, 25))
        ...
        for i, (campo, valor) in enumerate(campos):
            tk.Label(info_frame, text=f"{campo}:", font=("Segoe UI", 10, "bold"),
                     bg=COLORS["bg_card"], fg=COLORS["text_dark"]).grid(row=i, column=0, sticky="e", padx=10, pady=4)
            tk.Label(info_frame, text=valor, font=FONT_NORMAL,
                     bg=COLORS["bg_card"], fg=COLORS["text_dark"]).grid(row=i, column=1, sticky="w", padx=10, pady=4)
        ...
        col_widths = [120, 100, 100, 160, 120]
        for col, width in zip(columnas, col_widths):
        ...
        if not fechas_ordenadas:
            self.tabla.insert("", "end", values=("No hay datos para mostrar", "", "", "", ""))
            return
